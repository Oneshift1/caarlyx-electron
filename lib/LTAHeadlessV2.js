...
async function getRebateInfo(data) {
    ...
    try {
        ...
        await sleep(100);
        await page.type('input[name=vehicleNo][type=text]', data.license_plate);
        await sleep(100);
        ...
        await sleep(100);
        await page.type('input[name=ownerId][type=text]', data.owner_id);
        await sleep(100);

        await page.click('input[name=intendedDeRegDate][type=text]');
        await sleep(100);
        await page.type('input[name=intendedDeRegDate][type=text]', data.intended_transfer_date);
        await sleep(100);
...
async function getTransferInfo(data) {
    ...
    try {
        ...
        await sleep(100);
        await page.type('#ownerId', data.owner_id);
        await sleep(100);

        await page.click('#vehicleNo');
        await sleep(100);
        await page.type('#vehicleNo', data.license_plate);
        await sleep(100);

        await page.click('#transferDate');
        await sleep(100);
        await page.type('#transferDate', data.intended_transfer_date);
        await sleep(100);
...
async function getRoadTaxInfo(data) {
    ...
    try {
        ...
        await sleep(100);
        await page.type('#vehNoField', data.license_plate);
        await sleep(100);
